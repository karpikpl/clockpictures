...
358000 359000 0 1000 2000")))
        ...
        [Test]
        public void SampleTest_WithStringData_Should_Pass_When_SameData()
        {
            // Arrange
            const string expectedAnswer = "possible\n";
            StringBuilder sb1 = new StringBuilder();
            ...
            using (var input = new MemoryStream(Encoding.UTF8.GetBytes("199999\n" + sb1 + "\n" + sb1)))
            using (var output = new MemoryStream())
            {
                // Act
                Program.Solve(input, output);
        ...
        [Test]
        public void GetDiffs_Should_ReturnDiffsBetweenHands2()
        {
            // Arrange
            int[] data = new[] { 10000, 90000, 180000, 270000, 290000 };
            int[] expected = new[] { 80000, 90000, 90000, 20000, 80000 };
        ...
        [Test]
        public void Compact_Should_Not_CompactArray_When_NoRepetitions()
        {
            // Arrange
            int[] data = new[] { 1, 2, 3, 1, 2, 3, 2, 3, 1, 2 };
            string[] expected = new[] { "1", "2", "3", "1", "2", "3", "2", "3", "1", "2" };
